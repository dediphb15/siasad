    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="defaultModalLabel"><span id="title">Tambah Gallery</span></h4>
        </div>
        <div class="modal-body">
          <form id="form" enctype="multipart/form-data">
            <div class="form-group">
              <label for="exampleInputEmail1">Judul *</label>
              <input type="text" class="form-control" name="judul" id="judul" placeholder="Enter Judul" required="required">
...
<script type="text/javascript">
 ...
 serverSide: true,
      ...
      // destroy: true,
      // searching: false 
      ajax: {"url": "admin/berita/tampil_berita", "type": "POST"},
      columns: [
      {
        "data": "id"
        // "orderable": false
...
<?php } ?>
  ...
  function add(){
    ...
    if(id == 0){
     urldata = "<?php echo base_url()?>tambah-berita"
   }else{
     urldata = "<?php echo base_url()?>update-berita"
   }
  ...
  function getdatabyid(id){
    ...
    $('#title').html('Ubah Berita');
    $.ajax({
      url : "<?php echo base_url()?>admin/berita/get_berita",
      type: "POST",
      data: {id:id},
      dataType : "JSON",
    ...
    swal({
     ...
     $.ajax({
      url : "<?php echo base_url()?>hapus-berita",
      type: "POST",
      data: {id:id},
      dataType : "JSON",
      success: function(response) {
