                    ...
                    <div class="col-12 col-lg-7 col-xl-9 width-chat" id="chat">
                      ...
                      <div class="flex-grow-0 py-3 px-4 border-top">
                        <div class="input-group">
                          <input type="text" id="chatSend" class="form-control" placeholder="Type your message" required="required">
      ...
      $.ajax({
       ...
       success:function(data){
        ...
        for (var i = 0; i < data.length; i++) {
          html += '<a href="#" class="list-group-item list-group-item-action border-0" id="buka-chat" data-id='+data[i].session_id+'>'+
            ...
            for (var i = 0; i < data.length; i++) {
              if (data[i].user_2 == id) {
                 html += '<div class="chat-message-right mb-4">'+
                            ...
                            '</div>'+
                            '<div class="flex-shrink-1 bg-light rounded py-2 px-3 mr-3">'+
                              '<div class="font-weight-bold mb-1">You</div>'+data[i].pesan+'</div>'+
                          '</div>';
              }else{
