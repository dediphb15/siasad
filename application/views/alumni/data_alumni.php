...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="card">
      ...
      <!--     <button class="btn btn-default btn-tool" onclick="add();"><i class="fa fa-plus"></i> Tambah</button><button class="btn bg-green" onclick="print();">Print</button> -->
        </div>
      </div>

      <div class="card-body">
        Cari Berdasarkan 
        <form action="<?php base_url()?>alumni" method="POST">
          <div class="row">
            <div class="col-2">
            ...
            <div class="col-3">
               <button type="submit" class="btn btn-primary">Cari</button> <a href="<?php base_url()?>alumni" class="btn btn-danger">Reset</a>
            </div>
          </div>
        </form>
        <br>
