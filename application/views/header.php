  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url()?>data-karyawan" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Data User</p>
                </a>
              </li>
           <li class="nav-item">
                <a href="<?php echo base_url()?>data-jabatan" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Jabatan</p>
                </a>
              </li>
        ...
        <?php } ?>
          <li class="nav-item">
            <a href="<?php echo base_url()?>data-siswa" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url()?>show-chat" class="nav-link">
              <i class="nav-icon fas fa-newspaper"></i>
              <p>
                Forum
              </p>
          ...
          <li class="nav-item">
            <a href="<?php echo base_url()?>logout-admin" class="nav-link">
